                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="{{url('category')}}">Catagory</a>
                                        <a class="dropdown-item" href="{{url('single-blog')}}">Single Blog</a>
                                        <a class="dropdown-item" href="{{url('regular-page')}}">Regular Page</a>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="post-content-area mb-50">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="world-tab-1" role="tabpanel" aria-labelledby="tab1">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 bebas-aja">
                                            <!-- Single Blog Post -->
                        ...
                        <!-- Catagory Area -->
                        <div class="world-catagory-area mt-50 berita">
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                <div class="tab-pane fade show active" id="world-tab-10" role="tabpanel" aria-labelledby="tab10">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 bebas">
                                            <!-- Single Blog Post -->
